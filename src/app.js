...
export const STRINGS = {
  en: {
    ...
    walTop: 'Largest expense', pDay: 'Day', pWeek: 'Week', pMonth: 'Month', pSem: 'Semester', pYear: 'Year', pDec: 'Decade', walNet: 'Net', walEmpty: 'No transactions yet', walCurrency: 'Currency symbol', walDelete: 'Delete entry', walCurSearch: 'Search currencies…', launchpad: 'Launchpad', lpClock: 'Clock', lpClockSub: 'Drift-corrected world clock', lpWalletSub: 'Balance, daily spending & reports', lpOffline: 'Offline single-file',
    ...
    addZone: 'Add zone', single: 'Single', side: 'Side by side', quad: '2 × 2', grid16: '4 × 4', clearAll: 'Clear all', aiTip: 'On-device AI (WebGPU) for loose commands and light questions', timeIn: 'It is {t} in {c}.', remindSet: 'Reminder in {n} min', remindNow: 'Time’s up', clearChat: 'clear chat', voiceTip: 'Speak replies aloud',
  ...
  'zh-Hant': {
    ...
    walTop: '最大支出', pDay: '日', pWeek: '週', pMonth: '月', pSem: '學期', pYear: '年', pDec: '十年', walNet: '淨額', walEmpty: '尚無交易', walCurrency: '貨幣符號', walDelete: '刪除項目', walCurSearch: '搜尋貨幣…', launchpad: '啟動台', lpClock: '時鐘', lpClockSub: '漂移校正世界時鐘', lpWalletSub: '餘額、每日花費與報表', lpOffline: '離線單一檔案',
    ...
    addZone: '新增時區', single: '單一', side: '並排', quad: '2 × 2', grid16: '4 × 4', clearAll: '全部清除', aiTip: '本機 AI（WebGPU）：隨意說法與輕鬆問答', timeIn: '{c} 現在是 {t}。', remindSet: '{n} 分鐘後提醒您', remindNow: '時間到了', clearChat: '清除對話', voiceTip: '朗讀回覆',
  ...
  hi: {
    ...
    addZone: 'ज़ोन जोड़ें', single: 'एकल', side: 'साथ-साथ', quad: '2 × 2', grid16: '4 × 4', clearAll: 'सभी साफ़ करें', aiTip: 'ढीले कमांड और हल्के सवालों के लिए डिवाइस पर AI (WebGPU)', timeIn: '{c} में अभी {t} बजे हैं।', remindSet: '{n} मिनट में याद दिलाऊँगा', remindNow: 'समय हो गया', clearChat: 'चैट साफ़ करें', voiceTip: 'जवाब बोलकर सुनाएँ',
  ...
  es: {
    ...
    walTop: 'Mayor gasto', pDay: 'Día', pWeek: 'Semana', pMonth: 'Mes', pSem: 'Semestre', pYear: 'Año', pDec: 'Década', walNet: 'Neto', walEmpty: 'Sin movimientos aún', walCurrency: 'Símbolo de moneda', walDelete: 'Eliminar entrada', walCurSearch: 'Buscar divisas…', launchpad: 'Launchpad', lpClock: 'Reloj', lpClockSub: 'Reloj mundial con deriva corregida', lpWalletSub: 'Saldo, gasto diario e informes', lpOffline: 'Un solo archivo sin conexión',
    ...
    addZone: 'Añadir zona', single: 'Único', side: 'Lado a lado', quad: '2 × 2', grid16: '4 × 4', clearAll: 'Borrar todo', aiTip: 'IA en tu dispositivo (WebGPU) para órdenes libres y preguntas ligeras', timeIn: 'Son las {t} en {c}.', remindSet: 'Aviso en {n} min', remindNow: 'Se acabó el tiempo', clearChat: 'borrar chat', voiceTip: 'Leer respuestas en voz alta',
  ...
  fr: {
    ...
    addZone: 'Ajouter un fuseau', single: 'Seul', side: 'Côte à côte', quad: '2 × 2', grid16: '4 × 4', clearAll: 'Tout effacer', aiTip: 'IA locale (WebGPU) pour des ordres libres et des questions légères', timeIn: 'Il est {t} à {c}.', remindSet: 'Rappel dans {n} min', remindNow: 'C’est l’heure', clearChat: 'effacer la conversation', voiceTip: 'Lire les réponses à voix haute',
  ...
  ar: {
    ...
    addZone: 'أضف منطقة', single: 'واحدة', side: 'جنباً إلى جنب', quad: '2 × 2', grid16: '4 × 4', clearAll: 'مسح الكل', aiTip: 'ذكاء اصطناعي على جهازك (WebGPU) للأوامر الحرة والأسئلة الخفيفة', timeIn: 'الساعة {t} في {c}.', remindSet: 'تذكير بعد {n} د', remindNow: 'انتهى الوقت', clearChat: 'مسح المحادثة', voiceTip: 'انطق الردود',
  ...
  bn: {
    ...
    walTop: 'সবচেয়ে বড় খরচ', pDay: 'দিন', pWeek: 'সপ্তাহ', pMonth: 'মাস', pSem: 'সেমিস্টার', pYear: 'বছর', pDec: 'দশক', walNet: 'নিট', walEmpty: 'এখনও কোনো লেনদেন নেই', walCurrency: 'মুদ্রা চিহ্ন', walDelete: 'মুছুন', walCurSearch: 'মুদ্রা খুঁজুন…', launchpad: 'লঞ্চপ্যাড', lpClock: 'ঘড়ি', lpClockSub: 'ড্রিফট-সংশোধিত বিশ্বঘড়ি', lpWalletSub: 'ব্যালেন্স, দৈনিক খরচ ও রিপোর্ট', lpOffline: 'অফলাইন একক ফাইল',
    ...
    addZone: 'অঞ্চল যোগ করুন', single: 'একক', side: 'পাশাপাশি', quad: '2 × 2', grid16: '4 × 4', clearAll: 'সব মুছুন', aiTip: 'ঢিলা কমান্ড ও হালকা প্রশ্নের জন্য ডিভাইসে AI (WebGPU)', timeIn: '{c}-এ এখন {t}টা।', remindSet: '{n} মিনিটে মনে করাব', remindNow: 'সময় শেষ', clearChat: 'চ্যাট মুছুন', voiceTip: 'উত্তর পড়ে শোনান',
  ...
  ru: {
    ...
    addZone: 'Добавить пояс', single: 'Один', side: 'Рядом', quad: '2 × 2', grid16: '4 × 4', clearAll: 'Очистить всё', aiTip: 'ИИ на устройстве (WebGPU) для свободных команд и лёгких вопросов', timeIn: 'В {c} сейчас {t}.', remindSet: 'Напомню через {n} мин', remindNow: 'Время вышло', clearChat: 'очистить чат', voiceTip: 'Озвучивать ответы',
  ...
  pt: {
    ...
    walTop: 'Maior gasto', pDay: 'Dia', pWeek: 'Semana', pMonth: 'Mês', pSem: 'Semestre', pYear: 'Ano', pDec: 'Década', walNet: 'Líquido', walEmpty: 'Sem transações ainda', walCurrency: 'Símbolo de moeda', walDelete: 'Excluir entrada', walCurSearch: 'Buscar moedas…', launchpad: 'Launchpad', lpClock: 'Relógio', lpClockSub: 'Relógio mundial com deriva corrigida', lpWalletSub: 'Saldo, gastos diários e relatórios', lpOffline: 'Arquivo único off-line',
    ...
    addZone: 'Adicionar fuso', single: 'Único', side: 'Lado a lado', quad: '2 × 2', grid16: '4 × 4', clearAll: 'Limpar tudo', aiTip: 'IA no dispositivo (WebGPU) para comandos livres e perguntas leves', timeIn: 'São {t} em {c}.', remindSet: 'Lembrete em {n} min', remindNow: 'Hora certa', clearChat: 'limpar conversa', voiceTip: 'Falar as respostas',
  ...
  ur: {
    ...
    walTop: 'سب سے بڑا خرچ', pDay: 'دن', pWeek: 'ہفتہ', pMonth: 'مہینہ', pSem: 'سیمسٹر', pYear: 'سال', pDec: 'دہائی', walNet: 'خالص', walEmpty: 'ابھی کوئی لین دین نہیں', walCurrency: 'کرنسی کا نشان', walDelete: 'اندراج حذف کریں', walCurSearch: 'کرنسی تلاش کریں…', launchpad: 'لائنچ پیڈ', lpClock: 'گھڑی', lpClockSub: 'ڈرفٹ درست شدہ عالمی گھڑی', lpWalletSub: 'بیلنس، یومیہ خرچ اور رپورٹس', lpOffline: 'آف لائن سنگل فائل',
    ...
    addZone: 'زون شامل کریں', single: 'واحد', side: 'بہ پہلو', quad: '2 × 2', grid16: '4 × 4', clearAll: 'سب صاف کریں', aiTip: 'ڈھیلے کمانڈز اور ہلکے سوالات کے لیے ڈیوائس پر AI (WebGPU)', timeIn: '{c} میں ابھی {t} بجے ہیں۔', remindSet: '{n} منٹ میں یاد دہانی', remindNow: 'وقت ہو گیا', clearChat: 'چیٹ صاف کریں', voiceTip: 'جواب بول کر سنائیں',
