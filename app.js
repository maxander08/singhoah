...
export const STRINGS = {
  ...
  'zh-Hant': {
    ...
    addZone: '新增時區', single: '單一', side: '並排', quad: '2 × 2', grid16: '4 × 4', clearAll: '全部清除', aiTip: '本機 AI（WebGPU）：隨意說法與輕鬆問答',
  ...
  hi: {
    ...
    addZone: 'ज़ोन जोड़ें', single: 'एकल', side: 'साथ-साथ', quad: '2 × 2', grid16: '4 × 4', clearAll: 'सभी साफ़ करें', aiTip: 'ढीले कमांड और हल्के सवालों के लिए डिवाइस पर AI (WebGPU)',
  ...
  es: {
    ...
    addZone: 'Añadir zona', single: 'Único', side: 'Lado a lado', quad: '2 × 2', grid16: '4 × 4', clearAll: 'Borrar todo', aiTip: 'IA en tu dispositivo (WebGPU) para órdenes libres y preguntas ligeras',
  ...
  fr: {
    ...
    addZone: 'Ajouter un fuseau', single: 'Seul', side: 'Côte à côte', quad: '2 × 2', grid16: '4 × 4', clearAll: 'Tout effacer', aiTip: 'IA locale (WebGPU) pour des ordres libres et des questions légères',
  ...
  ar: {
    ...
    addZone: 'أضف منطقة', single: 'واحدة', side: 'جنباً إلى جنب', quad: '2 × 2', grid16: '4 × 4', clearAll: 'مسح الكل', aiTip: 'ذكاء اصطناعي على جهازك (WebGPU) للأوامر الحرة والأسئلة الخفيفة',
  ...
  bn: {
    ...
    addZone: 'অঞ্চল যোগ করুন', single: 'একক', side: 'পাশাপাশি', quad: '2 × 2', grid16: '4 × 4', clearAll: 'সব মুছুন', aiTip: 'ঢিলা কমান্ড ও হালকা প্রশ্নের জন্য ডিভাইসে AI (WebGPU)',
  ...
  ru: {
    ...
    addZone: 'Добавить пояс', single: 'Один', side: 'Рядом', quad: '2 × 2', grid16: '4 × 4', clearAll: 'Очистить всё', aiTip: 'ИИ на устройстве (WebGPU) для свободных команд и лёгких вопросов',
  ...
  pt: {
    ...
    addZone: 'Adicionar fuso', single: 'Único', side: 'Lado a lado', quad: '2 × 2', grid16: '4 × 4', clearAll: 'Limpar tudo', aiTip: 'IA no dispositivo (WebGPU) para comandos livres e perguntas leves',
  ...
  ur: {
    ...
    addZone: 'زون شامل کریں', single: 'واحد', side: 'بہ پہلو', quad: '2 × 2', grid16: '4 × 4', clearAll: 'سب صاف کریں', aiTip: 'ڈھیلے کمانڈز اور ہلکے سوالات کے لیے ڈیوائس پر AI (WebGPU)',
