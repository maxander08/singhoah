...
export const STRINGS = {
  ...
  'zh-Hant': {
    ...
    resync: '重新同步', search: '搜尋城市或國家…', signin: '登入', signout: '登出', account: '帳戶', settings: '設定', appearance: '外觀', homeCity: '時鐘城市', currency: '貨幣', data: '資料', resetData: '重設本地資料', resetQ: '清除此裝置上的語言、外觀、城市、貨幣與帳戶快照？錢包交易會保留。', portalNote: '登入後，您的語言、外觀、城市、貨幣與錢包將隨 Google 帳戶在任何裝置上同步。', lpSettingsSub: '語言、外觀、城市與貨幣', language: '語言', local: '本地',
  ...
  ar: {
    ...
    resync: 'إعادة المزامنة', search: 'ابحث عن مدينة أو دولة…', signin: 'تسجيل الدخول', signout: 'تسجيل الخروج', account: 'الحساب', settings: 'الإعدادات', appearance: 'المظهر', homeCity: 'مدينة الساعة', currency: 'العملة', data: 'البيانات', resetData: 'إعادة تعيين البيانات المحلية', resetQ: 'مسح اللغة والسمة والمدينة والعملة ولقطات الحساب على هذا الجهاز؟ سيتم الاحتفاظ بالمعاملات.', portalNote: 'سجّل الدخول وستتبع لغتك وسمتك ومدينتك وعملتك ومحفظتك حساب Google على أي جهاز.', lpSettingsSub: 'اللغة والسمة والمدينة والعملة', language: 'اللغة', local: 'محلي',
