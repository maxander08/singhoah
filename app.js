...
export const STRINGS = {
  en: {
    ...
    resync: 'Re-sync', search: 'Search city or country…', language: 'Language', local: 'Local',
  ...
  'zh-Hant': {
    ...
    resync: '重新同步', search: '搜尋城市或國家…', language: '語言', local: '本地',
  ...
  hi: {
    ...
    resync: 'री-सिंक', search: 'शहर या देश खोजें…', language: 'भाषा', local: 'स्थानीय',
  ...
  es: {
    ...
    resync: 'Resincronizar', search: 'Buscar ciudad o país…', language: 'Idioma', local: 'Local',
  ...
  fr: {
    ...
    resync: 'Resynchroniser', search: 'Rechercher une ville ou un pays…', language: 'Langue', local: 'Local',
  ...
  ar: {
    ...
    resync: 'إعادة المزامنة', search: 'ابحث عن مدينة أو دولة…', language: 'اللغة', local: 'محلي',
  ...
  bn: {
    ...
    resync: 'রি-সিঙ্ক', search: 'শহর বা দেশ খুঁজুন…', language: 'ভাষা', local: 'স্থানীয়',
  ...
  ru: {
    ...
    resync: 'Синхронизировать', search: 'Поиск города или страны…', language: 'Язык', local: 'Местное',
  ...
  pt: {
    ...
    resync: 'Ressincronizar', search: 'Buscar cidade ou país…', language: 'Idioma', local: 'Local',
  ...
  ur: {
    ...
    resync: 'دوبارہ سنک', search: 'شہر یا ملک تلاش کریں…', language: 'زبان', local: 'مقامی',
