...
export const STRINGS = {
  en: {
    ...
    resync: 'Re-sync', search: 'Search city or country…', signin: 'Sign in', signout: 'Sign out', account: 'Account', language: 'Language', local: 'Local',
  ...
  'zh-Hant': {
    ...
    resync: '重新同步', search: '搜尋城市或國家…', signin: '登入', signout: '登出', account: '帳戶', language: '語言', local: '本地',
  ...
  hi: {
    ...
    resync: 'री-सिंक', search: 'शहर या देश खोजें…', signin: 'साइन इन', signout: 'साइन आउट', account: 'खाता', language: 'भाषा', local: 'स्थानीय',
  ...
  es: {
    ...
    resync: 'Resincronizar', search: 'Buscar ciudad o país…', signin: 'Iniciar sesión', signout: 'Cerrar sesión', account: 'Cuenta', language: 'Idioma', local: 'Local',
  ...
  fr: {
    ...
    resync: 'Resynchroniser', search: 'Rechercher une ville ou un pays…', signin: 'Connexion', signout: 'Déconnexion', account: 'Compte', language: 'Langue', local: 'Local',
  ...
  ar: {
    ...
    resync: 'إعادة المزامنة', search: 'ابحث عن مدينة أو دولة…', signin: 'تسجيل الدخول', signout: 'تسجيل الخروج', account: 'الحساب', language: 'اللغة', local: 'محلي',
  ...
  bn: {
    ...
    resync: 'রি-সিঙ্ক', search: 'শহর বা দেশ খুঁজুন…', signin: 'সাইন ইন', signout: 'সাইন আউট', account: 'অ্যাকাউন্ট', language: 'ভাষা', local: 'স্থানীয়',
  ...
  ru: {
    ...
    resync: 'Синхронизировать', search: 'Поиск города или страны…', signin: 'Войти', signout: 'Выйти', account: 'Аккаунт', language: 'Язык', local: 'Местное',
  ...
  pt: {
    ...
    resync: 'Ressincronizar', search: 'Buscar cidade ou país…', signin: 'Entrar', signout: 'Sair', account: 'Conta', language: 'Idioma', local: 'Local',
  ...
  ur: {
    ...
    resync: 'دوبارہ سنک', search: 'شہر یا ملک تلاش کریں…', signin: 'سائن ان', signout: 'سائن آؤٹ', account: 'اکاؤنٹ', language: 'زبان', local: 'مقامی',
