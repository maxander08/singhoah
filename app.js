...
export const STRINGS = {
  ...
  'zh-Hant': {
    ...
    resync: '重新同步', search: '搜尋城市或國家…', signin: '登入', signout: '登出', account: '帳戶', settings: '設定', appearance: '外觀', homeCity: '時鐘城市', currency: '貨幣', data: '資料', resetData: '重設本地資料', resetQ: '清除此裝置上的語言、外觀、城市、貨幣與帳戶快照？錢包交易會保留。', portalNote: '從頁首登入，即可在此裝置上為每個 Google 帳戶保存這些設定。', lpSettingsSub: '語言、外觀、城市與貨幣', language: '語言', local: '本地',
  ...
  ar: {
    ...
    resync: 'إعادة المزامنة', search: 'ابحث عن مدينة أو دولة…', signin: 'تسجيل الدخول', signout: 'تسجيل الخروج', account: 'الحساب', settings: 'الإعدادات', appearance: 'المظهر', homeCity: 'مدينة الساعة', currency: 'العملة', data: 'البيانات', resetData: 'إعادة تعيين البيانات المحلية', resetQ: 'مسح اللغة والسمة والمدينة والعملة ولقطات الحساب على هذا الجهاز؟ سيتم الاحتفاظ بالمعاملات.', portalNote: 'سجّل الدخول من الترويسة للاحتفاظ بهذه الإعدادات لكل حساب Google على هذا الجهاز.', lpSettingsSub: 'اللغة والسمة والمدينة والعملة', language: 'اللغة', local: 'محلي',
  ...
  bn: {
    ...
    resync: 'রি-সিঙ্ক', search: 'শহর বা দেশ খুঁজুন…', signin: 'সাইন ইন', signout: 'সাইন আউট', account: 'অ্যাকাউন্ট', settings: 'সেটিংস', appearance: 'চেহারা', homeCity: 'ঘড়ির শহর', currency: 'মুদ্রা', data: 'ডেটা', resetData: 'স্থানীয় ডেটা রিসেট', resetQ: 'এই ডিভাইসে ভাষা, থিম, শহর, মুদ্রা ও অ্যাকাউন্ট স্ন্যাপশট মুছবেন? ওয়ালেটের লেনদেন থাকবে।', portalNote: 'এই ডিভাইসে প্রতিটি Google অ্যাকাউন্টের জন্য এই সেটিংস রাখতে শীর্ষ থেকে সাইন ইন করুন।', lpSettingsSub: 'ভাষা, থিম, শহর ও মুদ্রা', language: 'ভাষা', local: 'স্থানীয়',
  ...
  ur: {
    ...
    resync: 'دوبارہ سنک', search: 'شہر یا ملک تلاش کریں…', signin: 'سائن ان', signout: 'سائن آؤٹ', account: 'اکاؤنٹ', settings: 'ترتیبات', appearance: 'ظاہری شکل', homeCity: 'گھڑی کا شہر', currency: 'کرنسی', data: 'ڈیٹا', resetData: 'مقامی ڈیٹا ری سیٹ', resetQ: 'اس آلے پر زبان، تھیم، شہر، کرنسی اور اکاؤنٹ اسنیپ شاٹس صاف کریں؟ والٹ کے لین دین محفوظ رہیں گے۔', portalNote: 'اس آلے پر ہر Google اکاؤنٹ کے لیے یہ ترتیبات رکھنے کے لیے ہیڈر سے سائن ان کریں۔', lpSettingsSub: 'زبان، تھیم، شہر اور کرنسی', language: 'زبان', local: 'مقامی',
